...
def team(team):
    ...
    return render_template('team.html', team = data, check_fav = check_fav)
...
def addfavourites(team):
    ...
    data = get_team_info(team)
    return render_template('team.html', team = data, check_fav = True)
...
def removeFavourites(team):
    ...
    data = get_team_info(team)
    return render_template('team.html', team = data, check_fav = False)
...
def favouriteTeam():
    ...
    return render_template('favourite.html', team = data)
